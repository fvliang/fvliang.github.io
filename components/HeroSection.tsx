  ...
  return (
    ...
    >
      <div className="text-center space-y-5">
        ...
        >
          <div className="w-48 h-48 md:w-56 md:h-56 rounded-full overflow-hidden border-2 border-gray-100">
            <img
              src="/me.jpg"
              alt="Fuliang Liu"
        ...
        >
          {[
            ...
            { href: "https://scholar.google.com/citations?user=0Y3bcg0AAAAJ&hl=zh-CN", title: "Google Scholar", d: "M5.242 13.769L0 9.5 12 0l12 9.5-5.242 4.269C17.548 11.249 14.978 9.5 12 9.5c-2.977 0-5.548 1.748-6.758 4.269zM12 10a7 7 0 100 14 7 7 0 000-14z" },
          ].map((item) => (
            <a
              key={item.title}
              href={item.href}
